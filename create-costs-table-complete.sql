-- Complete SQL script untuk membuat tabel costs dan mengisi data biaya
-- Jalankan di Supabase SQL Editor: https://supabase.com/dashboard/project/eknvmtigbjzjwclfcwlh/sql
...
-- 4. Create policy untuk allow all operations
...
-- 6. Hapus data yang ada (jika ada)
DELETE FROM costs;

-- 7. Insert data biaya lengkap sesuai gambar
...
-- 8. Verifikasi data yang diinsert
SELECT 
  category,
